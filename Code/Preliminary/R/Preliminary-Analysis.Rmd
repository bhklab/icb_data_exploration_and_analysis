...
After removing the missing values, the fitted logistic model demonstrates that TBC1D22B is associated with improved ICB response ($log\text{OR} = 0.63$ and $p = 0.003$).
...
outliers <- c("ENSG00000206106.2", "ENSG00000187082.2")
