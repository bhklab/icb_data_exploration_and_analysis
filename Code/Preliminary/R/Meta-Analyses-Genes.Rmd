...
The gene TMEM140 is associated with better survival ($logHR = -0.22$, $p = 5.4e-04$), while GOLGA8S is associated with worse survival ($logHR = 0.08$, $p = 4.7e-05$) with FDR < 0.15. The volcano plot shows the genes associated with OS with p < 0.05. 
