...
The gene TMEM140 is associated with better survival ($logHR = -0.22$, $p = 4.7e-04$, $FDR = 0.08$), while GOLGA8S is associated with worse survival ($logHR = 0.25$, $p = 4.5e-05$, $FDR = 0.01$). The volcano plot shows the genes associated with OS with p < 0.05. 
