...
dat_sample_braun = read.table('C:/ICBRoche/Data/ICB_Braun/ICB_Braun_metadata.tsv', sep="\t") %>% as.data.frame()
dim(dat_sample_braun)

# gene meta data
dat_gene_braun = read.table('C:/ICBRoche/Data/ICB_Braun/ICB_Braun_expr_genes.tsv', sep="\t") %>% as.data.frame()
dim(dat_gene_braun)

# RNA-seq expression data (i.e., log2(TPM + 0.001)) 
dat_exp_braun = read.table('C:/ICBRoche/Data/ICB_Braun/ICB_Braun_expr.tsv', sep="\t") %>% as.data.frame()
dim(dat_exp_braun)
...
# clinicopathological characteristics  
dat_sample_nathanson = read.table('C:/ICBRoche/Data/ICB_Nathanson/ICB_Nathanson_metadata.tsv', sep="\t") %>% as.data.frame()
dim(dat_sample_nathanson)

# gene meta data
dat_gene_nathanson = read.table('C:/ICBRoche/Data/ICB_Nathanson/ICB_Nathanson_expr_genes.tsv', sep="\t") %>% as.data.frame()
dim(dat_gene_nathanson)

# RNA-seq expression data (i.e., log2(TPM + 0.001)) 
dat_exp_nathanson = read.table('C:/ICBRoche/Data/ICB_Nathanson/ICB_Nathanson_expr.tsv', sep="\t") %>% as.data.frame()
...
# clinicopathological characteristics  
dat_sample_snyder = read.table('C:/ICBRoche/Data/ICB_Snyder/ICB_Snyder_metadata.tsv', sep="\t") %>% as.data.frame()
dim(dat_sample_snyder)

# gene meta data
dat_gene_snyder = read.table('C:/ICBRoche/Data/ICB_Snyder/ICB_Snyder_expr_genes.tsv', sep="\t") %>% as.data.frame()
dim(dat_gene_snyder)

# RNA-seq expression data (i.e., log2(TPM + 0.001)) 
dat_exp_snyder = read.table('C:/ICBRoche/Data/ICB_Snyder/ICB_Snyder_expr.tsv', sep="\t") %>% as.data.frame()
dim(dat_exp_snyder)
...
# clinicopathological characteristics  
dat_sample_van_allen = read.table('C:/ICBRoche/Data/ICB_Van_Allen/ICB_Van_Allen_metadata.tsv', sep="\t") %>% as.data.frame()
dim(dat_sample_van_allen)

# gene meta data
dat_gene_van_allen = read.table('C:/ICBRoche/Data/ICB_Van_Allen/ICB_Van_Allen_expr_genes.tsv', sep="\t") %>% as.data.frame()
dim(dat_gene_van_allen)

# RNA-seq expression data (i.e., log2(TPM + 0.001)) 
dat_exp_van_allen = read.table('C:/ICBRoche/Data/ICB_Van_Allen/ICB_Van_Allen_expr.tsv', sep="\t") %>% as.data.frame()
...
# clinicopathological characteristics  
dat_sample_hugo = read.table('C:/ICBRoche/Data/ICB_Hugo/ICB_Hugo_metadata.tsv', sep="\t") %>% as.data.frame()
dim(dat_sample_hugo)

# gene meta data
dat_gene_hugo = read.table('C:/ICBRoche/Data/ICB_Hugo/ICB_Hugo_expr_gene_tpm_genes.tsv', sep="\t") %>% as.data.frame()
dim(dat_gene_hugo)

# RNA-seq expression data (i.e., log2(TPM + 0.001)) 
dat_exp_hugo = read.table('C:/ICBRoche/Data/ICB_Hugo/ICB_Hugo_expr_gene_tpm.tsv', sep="\t") %>% as.data.frame()
dim(dat_exp_hugo)
...
# clinicopathological characteristics  
dat_sample_miao1 = read.table('C:/ICBRoche/Data/ICB_Miao1/ICB_Miao1_metadata.tsv', sep="\t") %>% as.data.frame()
dim(dat_sample_miao1)

# gene meta data
dat_gene_miao1 = read.table('C:/ICBRoche/Data/ICB_Miao1/ICB_Miao1_expr_genes.tsv', sep="\t") %>% as.data.frame()
dim(dat_gene_miao1)

# RNA-seq expression data (i.e., log2(TPM + 0.001)) 
dat_exp_miao1 = read.table('C:/ICBRoche/Data/ICB_Miao1/ICB_Miao1_expr.tsv', sep="\t") %>% as.data.frame()
dim(dat_exp_miao1)
...
# clinicopathological characteristics  
dat_sample_riaz = read.table('C:/ICBRoche/Data/ICB_Riaz/ICB_Riaz_metadata.tsv', sep="\t") %>% as.data.frame()
dim(dat_sample_riaz)

# gene meta data
dat_gene_riaz = read.table('C:/ICBRoche/Data/ICB_Riaz/ICB_Riaz_expr_gene_tpm_genes.tsv', sep="\t") %>% as.data.frame()
dim(dat_gene_riaz)

# RNA-seq expression data (i.e., log2(TPM + 0.001)) 
dat_exp_riaz = read.table('C:/ICBRoche/Data/ICB_Riaz/ICB_Riaz_expr_gene_tpm.tsv', sep="\t") %>% as.data.frame()
dim(dat_exp_riaz)
...
# clinicopathological characteristics  
dat_sample_gide = read.table('C:/ICBRoche/Data/ICB_Gide/ICB_Gide_metadata.tsv', sep="\t") %>% as.data.frame()
dim(dat_sample_gide)

# gene meta data
dat_gene_gide = read.table('C:/ICBRoche/Data/ICB_Gide/ICB_Gide_expr_gene_tpm_genes.tsv', sep="\t") %>% as.data.frame()
dim(dat_gene_gide)

# RNA-seq expression data (i.e., log2(TPM + 0.001)) 
dat_exp_gide = read.table('C:/ICBRoche/Data/ICB_Gide/ICB_Gide_expr_gene_tpm.tsv', sep="\t") %>% as.data.frame()
dim(dat_exp_gide)
...
# clinicopathological characteristics  
dat_sample_kim = read.table('C:/ICBRoche/Data/ICB_Kim/ICB_Kim_metadata.tsv', sep="\t") %>% as.data.frame()
dim(dat_sample_kim)

# gene meta data
dat_gene_kim = read.table('C:/ICBRoche/Data/ICB_Kim/ICB_Kim_expr_gene_tpm_genes.tsv', sep="\t") %>% as.data.frame()
dim(dat_gene_kim)

# RNA-seq expression data (i.e., log2(TPM + 0.001)) 
dat_exp_kim = read.table('C:/ICBRoche/Data/ICB_Kim/ICB_Kim_expr_gene_tpm.tsv', sep="\t") %>% as.data.frame()
dim(dat_exp_kim)
...
# clinicopathological characteristics  
dat_sample_vanDenEnde = read.table('C:/ICBRoche/Data/ICB_VanDenEnde/ICB_VanDenEnde_metadata.tsv', sep="\t") %>% as.data.frame()
dim(dat_sample_vanDenEnde)

# gene meta data
dat_gene_vanDenEnde = read.table('C:/ICBRoche/Data/ICB_VanDenEnde/ICB_VanDenEnde_expr_genes.tsv', sep="\t") %>% as.data.frame()
dim(dat_gene_vanDenEnde)

# RNA-seq expression data (i.e., log2(TPM + 0.001)) 
dat_exp_vanDenEnde = read.table('C:/ICBRoche/Data/ICB_VanDenEnde/ICB_VanDenEnde_expr.tsv', sep="\t") %>% as.data.frame()
...
The forest plot demonstrates the fitted logistic regression model under each study including  the logOR, SE and p-value. Then, the meta-analysis was applied to integrate the results across studies using DL method to estimate heterogeneity (i.e., $I^2 = 36\%$ and $p = 1.2e-01$). Both FE ($p = 0.22$) and RE ($p=0.61$) model show no statistically significant p-values after integration.      
