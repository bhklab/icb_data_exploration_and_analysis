...
The forest plot shows the estimate heterogeneity across studies $I^2 = 36\%$. In addition, both FE ($p = 0.22$) and RE ($p=0.61$) models show no association between TBC1D22B and ICB response.      
