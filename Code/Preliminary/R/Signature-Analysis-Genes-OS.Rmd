...
The meta-analysis was applied to integrate the results (logHR, SE) across studies using DL method to estimate heterogeneity. Signature CYT (logHR = -0.38, p = 0.04) and PDL1 (logHR = -0.42, p = 0.03) are associated with OS. The forestplots show significant heterogeneity across studies: CYT ($I^2 = 62\%$ and $p = 9.5e-03$) and PDL1 ($I^2 = 59\%$ and $p = 1.8e-02$).  
