...
load( "~/Result/denovo_Single_Gene/Single_Gene_COX_OS.RData" ) 
...
write.table(meta_res , file= "~/Result/denovo_Single_Gene/Meta-analysis_Single_Gene_OS.txt" , sep="\t" , quote=FALSE, row.names=FALSE )
save( meta_res , file= "~/Result/denovo_Single_Gene/Meta-analysis_Single_Gene_OS.RData" ) 
