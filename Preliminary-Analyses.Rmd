...
# gene meta data
dat_gene = read.table('C:/IOProject/Roche/ICB_Braun_expr_genes.tsv', sep="\t") %>% as.data.frame()
dim(dat_gene)

# RNA-seq expression data (i.e., log2(TPM + 0.001)) 
dat_exp = read.table('C:/IOProject/Roche/ICB_Braun_expr.tsv', sep="\t") %>% as.data.frame()
dim(dat_exp)
