...
load( "/home/bioinf/bhklab/farnoosh/PredictIO/Result/denovo_Single_Gene/Single_Gene_COX_PFS.RData" ) 
...
write.table(meta_res , file= "/home/bioinf/bhklab/farnoosh/PredictIO/Result/denovo_Single_Gene/Meta-analysis_Single_Gene_PFS.txt" , sep="\t" , quote=FALSE, row.names=FALSE )
save( meta_res , file= "/home/bioinf/bhklab/farnoosh/PredictIO/Result/denovo_Single_Gene/Meta-analysis_Single_Gene_PFS.RData" ) 
